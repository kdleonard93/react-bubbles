...
- [ ] Explain what a token is used for.
      Answer: a compact and self-contained method for securely transmitting information between parties encoded as a JSON object.

- [ ] What steps can you take in your web apps to keep your data secure? Using localStorage.protected Routes.

- [ ] Describe how web servers work. a web server is connected to the internet, and stores the code for different websites to be shared across the world at all times.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. C(Post) R(Get) U(Put) D(Delete)
